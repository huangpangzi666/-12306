...
function noChoseCity(t, e, i, a) {
    ...
    i = i || "347px",
    e = e || "0",
    t.parent().parent().find("[data-id=" + t.attr("id") + "]") && t.parent().parent().find("[data-id=" + t.attr("id") + "]").remove(),
    t.parent().parent().append('<div class="tooltip-error" data-id=' + t.attr("id") + ' style="left:' + i + "; top: " + e + '; display: block;"><i class="icon icon-plaint-fill"></i>' + a + "</div>")
}
function footerFn() {
...
!function(t) {
    ...
    !function(t) {
        t.fn.slide = function(e) {
            ...
            this.each(function() {
                var i, a = t.extend({}, t.fn.slide.defaults, e), n = t(this), o = a.effect, r = t(a.prevCell, n), s = t(a.nextCell, n), l = t(a.pageStateCell, n), c = t(a.playStateCell, n), d = t(a.titCell, n), u = d.size(), h = t(a.mainCell, n), f = h.children().size(), p = a.switchLoad, v = t(a.targetCell, n), m = parseInt(a.defaultIndex), g = parseInt(a.delayTime), _ = parseInt(a.interTime), w = (parseInt(a.triggerTime),
                parseInt(a.scroll)), y = "false" != a.autoPlay && 0 != a.autoPlay, x = "false" != a.opp && 0 != a.opp, b = "false" != a.autoPage && 0 != a.autoPage, C = "false" != a.pnLoop && 0 != a.pnLoop, S = "false" != a.mouseOverStop && 0 != a.mouseOverStop, D = "false" != a.defaultPlay && 0 != a.defaultPlay, T = "false" != a.returnDefault && 0 != a.returnDefault, k = isNaN(a.vis) ? 1 : parseInt(a.vis), $ = !-[1] && !window.XMLHttpRequest, j = 0, M = 0, L = 0, I = 0, F = a.easing, O = null, N = null, H = null, q = a.titOnClassName, E = d.index(n.find("." + q)), z = m = -1 == E ? m : E, P = m, U = m, Y = f >= k ? f % w != 0 ? f % w : w : 0, V = "leftMarquee" == o || "topMarquee" == o, Q = function() {
                ...
                if ("menu" == a.type)
                    return D && d.removeClass(q).eq(m).addClass(q),
                    d.hover(function() {
                        i = t(this).find(a.targetCell);
                        var e = d.index(t(this));
                        N = setTimeout(function() {
                            switch (m = e,
                            d.removeClass(q).eq(m).addClass(q),
                            Q(),
                            o) {
                            case "fade":
                                i.stop(!0, !0).animate({
                ...
                b) {
                    ...
                    if (1 == a.autoPage || "true" == a.autoPage)
                        ...
                        for (var A = 0; A < u; A++)
                            G += a.autoPage.replace("$", A + 1);
                    d.html(G);
                    var d = d.children()
                }
                if (f >= k) {
                    h.children().each(function() {
                        t(this).width() > L && (L = t(this).width(),
                        M = t(this).outerWidth(!0)),
                        t(this).height() > I && (I = t(this).height(),
                        j = t(this).outerHeight(!0))
                    });
                    var R = h.children()
                      , Z = function() {
                        for (var t = 0; t < k; t++)
                            R.eq(t).clone().addClass("clone").appendTo(h);
                        for (var t = 0; t < Y; t++)
                            R.eq(f - t - 1).clone().addClass("clone").prependTo(h)
                    };
                    switch (o) {
                    case "fold":
                        h.css({
                ...
                var K = function(t) {
                    var e = t * w;
                    return t == u ? e = f : -1 == t && f % w != 0 && (e = -f % w),
                    e
                }
                  , X = function(e) {
                    var i = function(i) {
                        for (var a = i; a < k + i; a++)
                            e.eq(a).find("img[" + p + "]").each(function() {
                                var e = t(this);
                                if (e.attr("src", e.attr(p)).removeAttr(p),
                                h.find(".clone")[0])
                                    for (var i = h.children(), a = 0; a < i.size(); a++)
                                        i.eq(a).find("img[" + p + "]").each(function() {
                  ...
                  , tt = function(t) {
                    if (!D || z != m || t || V) {
                        if (V ? m >= 1 ? m = 1 : m <= 0 && (m = 0) : (U = m,
                        m >= u ? m = 0 : m < 0 && (m = u - 1)),
                        Q(),
                        null != p && X(h.children()),
                        v[0] && (i = v.eq(m),
                        null != p && X(v),
                        "slideDown" == o ? (v.not(i).stop(!0, !0).slideUp(g),
                        i.slideDown(g, F, function() {
                            h[0] || W()
                        })) : (v.not(i).stop(!0, !0).hide(),
                        i.animate({
                            opacity: "show"
                        }, g, function() {
                            h[0] || W()
                        ...
                        f >= k)
                            ...
                            case "leftLoop":
                                ...
                                h.stop(!0, !0).animate({
                                    ...
                                    e <= -1 ? h.css("left", -(Y + (u - 1) * w) * M) : e >= u && h.css("left", -Y * M),
                                    W()
                                });
                                break;
                            case "topLoop":
                                ...
                                h.stop(!0, !0).animate({
                                    ...
                                    e <= -1 ? h.css("top", -(Y + (u - 1) * w) * j) : e >= u && h.css("top", -Y * j),
                                    W()
                                });
                                break;
                            case "leftMarquee":
                        ...
                        d.removeClass(q).eq(m).addClass(q),
                        z = m,
                        C || (s.removeClass("nextStop"),
                        r.removeClass("prevStop"),
                        0 == m && r.addClass("prevStop"),
                        m == u - 1 && s.addClass("nextStop")),
                ...
                T && n.hover(function() {
                    ...
                    H = setTimeout(function() {
                        m = P,
                        D ? tt() : "slideDown" == o ? i.slideUp(g, J) : i.animate({
                            opacity: "hide"
                        }, g, J),
                        z = m
                    }, 300)
                ...
                var et = function(t) {
                  ...
                  , at = function() {
                    S || !y || c.hasClass("pauseState") || (clearInterval(O),
                    et())
                }
                  , nt = function() {
                    (C || m != u - 1) && (m++,
    ...
    jQuery.extend(jQuery.easing, {
        ...
        easeInElastic: function(t, e, i, a, n) {
            ...
            s < Math.abs(a)) {
                ...
                var o = r / (2 * Math.PI) * Math.asin(a / s);
        ...
        easeOutBack: function(t, e, i, a, n, o) {
            return void 0 == o && (o = 1.70158),
            a * ((e = e / n - 1) * e * ((o + 1) * e + o) + 1) + i
        },
        easeInOutBack: function(t, e, i, a, n, o) {
            return void 0 == o && (o = 1.70158),
            (e /= n / 2) < 1 ? a / 2 * (e * e * ((1 + (o *= 1.525)) * e - o)) + i : a / 2 * ((e -= 2) * e * ((1 + (o *= 1.525)) * e + o) + 2) + i
        },
...
define("index/index-init", ["jquery", "core/common/jquery.SuperSlide", "core/common/common", "handlebars"], function(t, e, i, a) {
    function n() {
        function e(e) {
            function i() {
                setTimeout(function() {
                    "undefined" == window.isLogin && (window.isLogin = "N"),
                    window.ajaxLogin_flag ? t.ajax({
                        timeout: 1e4,
                        dataType: "jsonp",
                        xhrFields: {
                            withCredentials: !0
...
define("g/g-header", ["jquery"], function(t) {
    function e() {
        function e(t) {
            ...
            var e = t[2];
            return t[4] += "<li url=" + t[3] + '><i class="icon icon-' + e + ' "> </i>' + t[0] + '<span class="list-txt"></span></li>',
            resList = t[4],
            resList
        }
        function a(i) {
                ...
                success: function(a) {
                    ...
                    if (0 == u) {
                        for (var f = [{
                            ...
                            value: "订单",
                            ico: "dingdanchaxun"
                        }], u = f.length, p = "", v = 0; v <= u - 1; v++)
                            p += '<li><i class="icon icon-' + f[v].ico + ' "> </i>' + f[v].value + '<span class="list-txt"></span></li>';
                        return t(".search-down-list").html(p),
                        t(".search-down").fadeIn(),
                        void (l = "noresults")
                    }
                    for (var m = "", v = 0; v <= u - 1; v++)
                        if ("001" == a.data[v].type) {
                            var g = "huochepiao";
                    ...
                    t(".search-down-list").html(m),
                    t(".search-down").fadeIn(),
                    t(".search-down-list").off("click", "li").on("click", "li", function() {
                        var e = {
                            innerText: t(this)[0].innerText,
                            url: t(this)[0].getAttribute("url")
                        };
                        if ("" != e.url && void 0 != e.url && null != e.url) {
                            window.open(t(this).attr("url")),
                            c.unshift(e);
                            var i = c.slice(0, 10);
                            o("searchHistory", JSON.stringify(i), 60),
                            r = JSON.parse(n("searchHistory")),
                            d = r;
                            for (var a = "", s = 0; s <= d.length - 1; s++)
                                a += "<li url=" + d[s].url + ">" + d[s].innerText + "</li>";
        ...
        function o(t, e, i, a, n, o) {
            ...
            var s = new Date;
            s.setTime(s.getTime() + 1e3 * i),
            document.cookie = escape(t) + "=" + escape(e) + (a ? "; path=" + a : ";path=/") + "; domain=" + r + (o ? "; secure" : "") + ";expires=" + s
        }
        ...
        t(".header-search .search-input").on("focus", function() {
            ...
            t(".search-down").fadeOut(),
            t(".search-input").val(""),
            "" == t(".search-input").val() && (x = 0),
            n("searchHistory"))
                if (r = JSON.parse(n("searchHistory")),
                d = r,
                c = d,
                0 != d.length) {
                    for (var e = "", i = 0; i <= d.length - 1; i++)
                        e += "<li url=" + d[i].url + ">" + d[i].innerText + "</li>";
                    t(".search-history-list").html(e),
                    t(".search-history").fadeIn()
                } else
                    t(".search-history").fadeOut();
            else
                "" != d ? t(".search-history").fadeIn() : t(".search-history").fadeOut();
            t(".search-btn")[0].onclick = function() {
                var e = t(".header-search .search-input").val();
                if (e = e.replace(/^ +| +$/g, ""),
                !(e.length <= 0)) {
                    for (var i = t(".search-input").val(), h = "[@`~!#$^&*()=|{}':;',\\[\\].<>《》/?~！#￥……&*（）——|{}【】‘；：”“'。，、？]‘’", f = i.length, p = 0; p <= f - 1; p++)
                        if (h.indexOf(i[p]) > -1)
                            return;
                    1 == u && a(i);
                    ...
                    c.unshift(m),
                    s = c.slice(0, 10),
                    o("searchHistory", JSON.stringify(s), 60),
                    r = JSON.parse(n("searchHistory")),
                    d = r,
                    t(".search-input").val("");
                    for (var g = "", p = 0; p <= d.length; p++) {
                        for (var p = 0; p <= d.length - 1; p++)
                            g += "<li url=" + d[p].url + ">" + d[p].innerText + "</li>";
            ...
            t(".search-history-list")[0].onclick = function(e) {
                ...
                if ("li" === i.nodeName.toLowerCase()) {
                    if ("undefined" == i.getAttribute("url"))
                        return;
        ...
        if (navigator.userAgent.indexOf("Trident") > -1) {
            ...
            document.onmousedown = function(e) {
                ...
                if ("MSIE8.0" == g || "MSIE9.0" == g || "MSIE10.0" == g || "WOW64" == g) {
                    var i = e.clientX
                      , a = e.clientY
                      , n = t("#search-input").offset().left
                      , o = (window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth,
                    n + t("#search-input").outerWidth())
                      , r = t("#search-input").offset().top
                      , s = t("#search-input").outerHeight()
                      , l = r + s + 204;
                    (i < n || i > o || a < r || a > l) && (t(".search-down").fadeOut(),
                    t(".search-history").fadeOut(),
                    f.splice(0, f.length))
                }
            }
        } else
            t(".header-search .search-input").on("blur", function() {
                t(".search-history").fadeOut(),
        ...
        t(".header-search .search-input").on("keyup", function(e) {
            ...
            t(".search-history").fadeOut();
            _ = e.timeStamp,
            16 != e.keyCode && 38 != e.keyCode && 40 != e.keyCode && 37 != e.keyCode && 39 != e.keyCode && setTimeout(function() {
                try {
                    if (_ - e.timeStamp == 0) {
                        C = t(".search-input").val().toUpperCase(),
                        "" == C && (t(".search-down-list").html(""),
                        t(".search-down").fadeOut()),
                        f.push(C);
                        for (var i = "[@`~!#$^&*()=|{}':;',\\[\\].<>《》/?~！#￥……&*（）——|{}【】‘；：”“'。，、？]‘’", n = C.length, o = 0; o <= n - 1; o++) {
                            if (i.indexOf(C[o]) > -1)
                                return t(".search-down-list").html(""),
                                t(".search-down").fadeOut(),
                                void (u = !1);
                            u = !0
                        }
                        var r = f.length;
                        if ("" != C)
                            if (C.indexOf(f[r - 2]) > -1) {
                                t(".search-down-list").html(""),
                                w = JSON.parse(h),
                                y = w.length;
                                for (var s = "", l = 0, o = 0; o <= y - 1; o++)
                                    if (w[o].word.indexOf(C) > -1 && "001" == w[o].type) {
                                        l++,
                                        w[o].word = w[o].word.replace(C, '<span style="color:red;">' + C + "</span>");
                                        s += "<li url=" + w[o].url + '><i class="icon icon-huochepiao "> </i>' + w[o].word + '<span class="list-txt"></span></li>'
                                    }
                                0 == l && 1 == u && a(C),
                                t(".search-down-list").html(s)
                            } else
                                1 == u && a(C)
                    }
                } catch (e) {
            ...
            if (1 == x && 40 != e.keyCode && (x = 0),
            40 == e.keyCode && x <= l.length - 1) {
                x++;
                ...
                l.eq(x - 1).children().eq(0).css({
                    color: "white"
                }),
                t("#search-input").val(l.eq(x - 1)[0].innerText),
                x >= 0 && x < 7)
                    t(".search-down-list").scrollTop(0);
                else if (6 != x && parseInt(x / 6) >= 1) {
                    var v = parseInt(x / 6) + 1
                      , m = 204 * (v - 1) - 30;
            ...
            if (13 == e.keyCode) {
                ...
                0 == x ? (i(l.eq(0).attr("url")),
                g = l.eq(0).attr("url")) : (i(l.eq(x - 1).attr("url")),
                g = l.eq(x - 1).attr("url"));
                for (var S = {
                    innerText: C,
                    url: g
                }, D = "[@`~!#$^&*()=|{}':;',\\[\\].<>《》/?~！#￥……&*（）——|{}【】‘；：”“'。，、？]‘’", T = C.length, p = 0; p <= T - 1; p++)
                    if (D.indexOf(C[p]) > -1)
                        return;
                c.unshift(S),
                s = c.slice(0, 10),
            ...
            for (var k = "", p = 0; p <= d.length - 1; p++)
                k += "<li url=" + d[p].url + ">" + d[p].innerText + "</li>";
    ...
    function i() {
        ...
        t.ajax({
            ...
            timeout: 1e4,
            success: function(t) {
                t.data && (window.isStudentDatas = t.data.isstudentDate,
                window.studentDates = t.data.studentDate,
                stu_control = t.data.stu_control,
                other_control = t.data.other_control,
                "Y" === t.data.is_uam_login ? o() : "Y" == t.data.is_login && (e = "Y",
                window.isLogin = e,
    ...
    function a() {
        t("#J-header-login").show(),
        t("#J-header-logout").hide()
    }
    function n() {
        t("#J-header-login").hide(),
        t("#J-header-logout").show()
    }
    function o() {
        t.ajax({
            ...
            timeout: 1e4,
            success: function(e) {
                "0" == e.result_code && e.name ? (isLogin = "Y",
                window.isLogin = isLogin,
                window.ajaxLogin = (new Date).getTime(),
                n(),
                t("#J-header-logout a.txt-primary").html(e.name),
                t("#J-header-logout a.logout").attr("href", logout)) : (isLogin = "N",
                window.isLogin = isLogin,
                window.ajaxLogin = (new Date).getTime()),
                window.ajaxLogin_flag = !0
            },
    ...
    t("#index_ads") && t("#index_ads").length > 0 ? (t("#gLink").click(function() {
    ...
    t("a.goGonggao").on("click", function(e) {
        e.stopPropagation(),
        t(this).attr("href", "../../index.html#index_ads")
    })),
    {
        initialize: function() {
            e(),
    ...
    function a() {
        ...
        !function() {
            t.ajax({
                ...
                timeout: 1e4,
                success: function(i) {
                    var a = i.data.index_new_url1
                      , n = i.data.index_new_url2
                      , o = i.data.index_new_url3
                      , r = i.data.index_new_url4
                      , s = i.data.index_new_Service1
                      , l = i.data.index_new_Service2
                      , c = i.data.index_new_Service3
                      , d = i.data.index_new_Service4
                      , u = []
                      , h = [];
                    h.push(a, n, o, r),
                    u.push(s, l, c, d);
                ...
                error: function(e) {
                    ...
                    for (i = 0; i < a.length; i++)
                        n += "<li><a href=" + a[i].src + "><img src=" + a[i].img + "> </a></li>";
                    ...
                    for (j = 0; j < o.length; j++)
                        r += "<li><a href=" + o[j].src + '><div class="service-pic"><img src=' + o[j].img + '></div><div class="service-info"><h3 class="service-name">' + o[j].title + '</h3><p class="service-txt">' + o[j].notice + '</p><i class="icon icon-more"></i></div></a></li>';
        ...
        var n = function() {
            t.ajax({
                ...
                success: function(i) {
                    var a = i.data
                      ...
                      , o = e.compile(n)
                      , r = o(a);
                    t(".travel-train-list").html(r),
                    t(".box-loading").hide(),
                    t(".travel-train-list").show()
                },
                error: function(i) {
                    var a = {
                        index_travel_url: [{
          ...
          , r = function() {
            t.ajax({
                ...
                success: function(i) {
                    var a = i.data;
                    if (a.left && 0 == a.left.length)
                        t(".demo").removeClass("autoScroll"),
                        t(".dd_left").html('<img style="display: block;width: 100px;height: 80px;margin:15px auto" src=' + imgBan1 + '><div style="color: #999">暂无公示数据</div>');
                    else {
                    ...
                    if (a.right && 0 == a.right.length)
                        t(".demo1").removeClass("autoScroll"),
                        t(".dd_right").html('<img style="display: block;width: 100px;height: 80px;margin:15px auto" src=' + imgBan2 + '><div style="color: #999">暂无公示数据</div>');
                    else {
          ...
          , s = t(".header-wrap").height()
          , l = t(".fullSlide").height()
          , c = s + l
          , d = t(".service-lg").height()
          , u = c + d
          , h = !0
          , f = !0
          , p = !1
          , v = t(window)
          , m = t(".section-hd").offset().top
          , g = t(".section-hd").outerHeight()
          , _ = v.height()
          , w = v.scrollTop();
        if (w > m + g || w < m - _ || (p = !0),
        document.documentElement.clientHeight < document.documentElement.offsetHeight && !p) {
...
define("index/index-city", ["jquery", "core/common/messages_index_zh_CN", "cityName", "core/common/favorite_name"], function(t, e, i, a) {
    function n() {
            ...
            _index_initQueryInput: function(e, i, a, n) {
                t.stationFor12306.init([e, i], {
                    ...
                    confirmCallBack: function(e) {
                        ...
                        -1 != e[0].id.indexOf("from") && ("" != t("#" + i).val() && t("#" + i).val() != index_messages.jianma_hanzi && t("#" + i).val() != index_messages.jianpin_hanzi ? t("#" + i).select() : t("#" + i).val(""),
                        t("#" + i).focus()),
                        t("#fromStationText").val() && "简拼/全拼/汉字" !== t("#fromStationText").val() && (t("#fromStationText").removeClass("input-error"),
                        t("[data-id=fromStationText]").hide()),
                        t("#toStationText").val() && "简拼/全拼/汉字" !== t("#toStationText").val() && (t("#toStationText").removeClass("input-error"),
                        t("[data-id=toStationText]").hide()),
                        t("#fromStationFanText").val() && "简拼/全拼/汉字" !== t("#fromStationFanText").val() && (t("#fromStationFanText").removeClass("input-error"),
                        t("[data-id=fromStationFanText]").hide()),
                        t("#toStationFanText").val() && "简拼/全拼/汉字" !== t("#toStationFanText").val() && (t("#toStationFanText").removeClass("input-error"),
                        t("[data-id=toStationFanText]").hide()),
                        t("#fromStationSerialText").val() && "简拼/全拼/汉字" !== t("#fromStationSerialText").val() && (t("#fromStationSerialText").removeClass("input-error"),
                        t("[data-id=fromStationSerialText]").hide()),
                        t("#toStationSerialText").val() && "简拼/全拼/汉字" !== t("#toStationSerialText").val() && (t("#toStationSerialText").removeClass("input-error"),
                        t("[data-id=toStationSerialText]").hide()),
                        t("#destinationText").val() && "简拼/全拼/汉字" !== t("#destinationText").val() && (t("#destinationText").removeClass("input-error"),
                        t("[data-id=destinationText]").hide()),
                        t("#toStationDinnerText").val() && "简拼/全拼/汉字" !== t("#toStationDinnerText").val() && (t("#toStationDinnerText").removeClass("input-error"),
                        t("[data-id=toStationDinnerText]").hide()),
                        t("#fromStationDinnerText").val() && "简拼/全拼/汉字" !== t("#fromStationDinnerText").val() && (t("#fromStationDinnerText").removeClass("input-error"),
                        t("[data-id=fromStationDinnerText]").hide()),
                        t("#stationValueText").val() && "简拼/全拼/汉字" !== t("#stationValueText").val() && (t("#stationValueText").removeClass("input-error"),
                        t("[data-id=stationValueText]").hide()),
                        t("#start_sellText").val() && "简拼/全拼/汉字" !== t("#start_sellText").val() && (t("#start_sellText").removeClass("input-error"),
                        t("[data-id=start_sellText]").hide()),
                        jQuery.support.cors = !0,
                        t.ajax({
                            url: getZhengWan,
                            type: "POST",
                            dataType: "json",
                            data: {
                                train_station_code: t("#stationValue").val()
                            },
                            success: function(e) {
                                var i = e.data;
                                setLocalStorage("depotValue", i),
                                t("#numberValue").val(""),
                                t("#train_hide").html("");
                                ...
                                t("#numberValue").removeClass("input-error"),
                                t("[data-id=numberValue]").hide()
                            },
                            error: function(e) {
        ...
        t._index_initQueryInput("fromStationFan", "toStationFan", "fromStationFanText", "toStationFanText"),
        t._index_initQueryInput("fromStationSerial", "toStationSerial", "fromStationSerialText", "toStationSerialText"),
        t._index_initQueryInput("stationValue", "", "stationValueText", ""),
        t._index_initQueryInput("start_sell", "", "start_sellText", ""),
        t._index_initQueryInput("destination", "", "destinationText", "")
    }
    return {
        initialize: function() {
            n()
...
function(t) {
    ...
    function(t) {
        ...
        i.prototype.close = function(e) {
            ...
            t.support.transition && a.hasClass("fade") ? a.on(t.support.transition.end, i) : i())
        }
        ;
        var a = t.fn.alert;
        t.fn.alert = function(e) {
            return this.each(function() {
                var a = t(this)
                  , n = a.data("alert");
                n || a.data("alert", n = new i(this)),
                "string" == typeof e && n[e].call(a)
            })
        }
        ,
        ...
        t.fn.button = function(i) {
            return this.each(function() {
                var a = t(this)
                  , n = a.data("button")
                  , o = "object" == typeof i && i;
                n || a.data("button", n = new e(this,o)),
    ...
    function(t) {
        ...
        e.prototype = {
            ...
            slide: function(e, i) {
                var a, n = this.$element.find(".item.active"), o = i || n[e](), r = this.interval, s = "next" == e ? "left" : "right", l = "next" == e ? "first" : "last", c = this;
                if (this.sliding = !0,
                r && this.pause(),
        ...
        t.fn.carousel = function(i) {
            return this.each(function() {
                ...
                n || a.data("carousel", n = new e(this,o)),
                "number" == typeof i ? n.to(i) : r ? n[r]() : o.interval && n.pause().cycle()
            })
        }
        ,
        ...
        t(document).on("click.carousel.data-api", "[data-slide], [data-slide-to]", function(e) {
            var i, a, n = t(this), o = t(n.attr("data-target") || (i = n.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, "")), r = t.extend({}, o.data(), n.data());
            o.carousel(r),
            (a = n.attr("data-slide-to")) && o.data("carousel").pause().to(a).cycle(),
            e.preventDefault()
        })
    }(window.jQuery),
    function(t) {
        ...
        e.prototype = {
            ...
            show: function() {
                ...
                if (!this.transitioning && !this.$element.hasClass("in")) {
                    ...
                    (a = this.$parent && this.$parent.find("> .accordion-group > .in")) && a.length) {
                        if ((n = a.data("collapse")) && n.transitioning)
                            return;
                        a.collapse("hide"),
                        n || a.data("collapse", null)
                    }
                    this.$element[e](0),
            ...
            hide: function() {
                var e;
                !this.transitioning && this.$element.hasClass("in") && (e = this.dimension(),
            ...
            transition: function(e, i, a) {
                ...
                i.isDefaultPrevented() || (this.transitioning = 1,
                this.$element[e]("in"),
        ...
        t.fn.collapse = function(i) {
            return this.each(function() {
                ...
                n || a.data("collapse", n = new e(this,o)),
                "string" == typeof i && n[i]()
            })
        }
        ,
        ...
        t(document).on("click.collapse.data-api", "[data-toggle=collapse]", function(e) {
            var i, a = t(this), n = a.attr("data-target") || e.preventDefault() || (i = a.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, ""), o = t(n).data("collapse") ? "toggle" : a.data();
            a[t(n).hasClass("in") ? "addClass" : "removeClass"]("collapsed"),
            t(n).collapse(o)
        })
    }(window.jQuery),
    function(t) {
        ...
        n.prototype = {
            ...
            toggle: function(a) {
                ...
                if (!r.is(".disabled, :disabled"))
                    ...
                    o = n.hasClass("open"),
                    e(),
                    o || ("ontouchstart"in document.documentElement && t('<div class="dropdown-backdrop"/>').insertBefore(t(this)).on("click", e),
                    n.toggleClass("open")),
                    r.focus(),
                    !1
            },
            keydown: function(e) {
                var n, o, r, s, l;
                if (/(38|40|27)/.test(e.keyCode) && (n = t(this),
                e.preventDefault(),
                e.stopPropagation(),
                !n.is(".disabled, :disabled"))) {
                    if (r = i(n),
                    !(s = r.hasClass("open")) || s && 27 == e.keyCode)
                        return 27 == e.which && r.find(a).focus(),
                        n.click();
        ...
        t.fn.dropdown = function(e) {
            return this.each(function() {
                var i = t(this)
                  , a = i.data("dropdown");
                a || i.data("dropdown", a = new n(this)),
    ...
    function(t) {
        ...
        e.prototype = {
            ...
            backdrop: function(e) {
                ...
                if (this.isShown && this.options.backdrop) {
                    ...
                    t.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one(t.support.transition.end, e) : e()) : e && e()
            }
        };
        var i = t.fn.modal;
        t.fn.modal = function(i) {
            return this.each(function() {
                ...
                n || a.data("modal", n = new e(this,o)),
                "string" == typeof i ? n[i]() : o.show && n.show()
            })
        }
        ,
        t.fn.modal.defaults = {
        ...
        t(document).on("click.modal.data-api", '[data-toggle="modal"]', function(e) {
            var i = t(this)
              , a = i.attr("href")
              , n = t(i.attr("data-target") || a && a.replace(/.*(?=#[^\s]+$)/, ""))
              , o = n.data("modal") ? "toggle" : t.extend({
                remote: !/#/.test(a) && a
            }, n.data(), i.data());
            e.preventDefault(),
            n.modal(o).one("hide", function() {
                i.focus()
            })
        })
    }(window.jQuery),
    function(t) {
        ...
        e.prototype = {
            ...
            init: function(e, i, a) {
                ...
                l = r.length; l--; )
                    s = r[l],
                    "click" == s ? this.$element.on("click." + this.type, this.options.selector, t.proxy(this.toggle, this)) : "manual" != s && (n = "hover" == s ? "mouseenter" : "focus",
                    o = "hover" == s ? "mouseleave" : "blur",
                    this.$element.on(n + "." + this.type, this.options.selector, t.proxy(this.enter, this)),
            ...
            applyPlacement: function(t, e) {
                ...
                i = r[0].offsetWidth,
                a = r[0].offsetHeight),
                this.replaceArrow(n - s + i, i, "left")) : this.replaceArrow(a - l, a, "top"),
                o && r.offset(t)
            },
        ...
        t.fn.tooltip = function(i) {
            return this.each(function() {
                var a = t(this)
                  , n = a.data("tooltip")
                  , o = "object" == typeof i && i;
                n || a.data("tooltip", n = new e(this,o)),
                "string" == typeof i && n[i]()
            })
        }
        ,
        ...
        t.fn.popover = function(i) {
            return this.each(function() {
                var a = t(this)
                  , n = a.data("popover")
                  , o = "object" == typeof i && i;
                n || a.data("popover", n = new e(this,o)),
                "string" == typeof i && n[i]()
            })
        }
        ,
    ...
    function(t) {
        ...
        function e(e, i) {
            ...
            this.$scrollElement = o.on("scroll.scroll-spy.data-api", n),
            this.selector = (this.options.target || (a = t(e).attr("href")) && a.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a",
            this.$body = t("body"),
            this.refresh(),
            this.process()
        }
        e.prototype = {
            ...
            process: function() {
                var t, e = this.$scrollElement.scrollTop() + this.options.offset, i = this.$scrollElement[0].scrollHeight || this.$body[0].scrollHeight, a = i - this.$scrollElement.height(), n = this.offsets, o = this.targets, r = this.activeTarget;
                if (e >= a)
            ...
            activate: function(e) {
                ...
                i = t(a).parent("li").addClass("active"),
        ...
        t.fn.scrollspy = function(i) {
            return this.each(function() {
                var a = t(this)
                  , n = a.data("scrollspy")
                  , o = "object" == typeof i && i;
                n || a.data("scrollspy", n = new e(this,o)),
                "string" == typeof i && n[i]()
            })
        }
        ,
    ...
    function(t) {
        ...
        e.prototype = {
            ...
            show: function() {
                ...
                r || (r = n.attr("href"),
                r = r && r.replace(/.*(?=#[^\s]*$)/, "")),
                n.parent("li").hasClass("active") || (e = o.find(".active:last a")[0],
                a = t.Event("show", {
                    relatedTarget: e
                }),
                n.trigger(a),
                a.isDefaultPrevented() || (i = t(r),
                this.activate(n.parent("li"), o),
            ...
            activate: function(e, i, a) {
                ...
                var o = i.find("> .active")
                  , r = a && t.support.transition && o.hasClass("fade");
                r ? o.one(t.support.transition.end, n) : n(),
                o.removeClass("in")
            }
        };
        var i = t.fn.tab;
    ...
    function(t) {
        ...
        e.prototype = {
            ...
            lookup: function(e) {
                ...
                !this.query || this.query.length < this.options.minLength ? this.shown ? this.hide() : this : (i = t.isFunction(this.source) ? this.source(this.query, t.proxy(this.process, this)) : this.source,
            ...
            sorter: function(t) {
                for (var e, i = [], a = [], n = []; e = t.shift(); )
                    e.toLowerCase().indexOf(this.query.toLowerCase()) ? ~e.indexOf(this.query) ? a.push(e) : n.push(e) : i.push(e);
                return i.concat(a, n)
            },
            ...
            render: function(e) {
                ...
                return e = t(e).map(function(e, a) {
                    return e = t(i.options.item).attr("data-value", a),
                    e.find("a").html(i.highlighter(a)),
                    e[0]
                }),
        ...
        t.fn.typeahead = function(i) {
            return this.each(function() {
                var a = t(this)
                  , n = a.data("typeahead")
                  , o = "object" == typeof i && i;
                n || a.data("typeahead", n = new e(this,o)),
                "string" == typeof i && n[i]()
            })
        }
        ,
    ...
    function(t) {
        ...
        e.prototype.checkPosition = function() {
            if (this.$element.is(":visible")) {
                var e, i = t(document).height(), a = this.$window.scrollTop(), n = this.$element.offset(), o = this.options.offset, r = o.bottom, s = o.top;
                "object" != typeof o && (r = s = o),
                "function" == typeof s && (s = o.top()),
                "function" == typeof r && (r = o.bottom()),
                e = !(null != this.unpin && a + this.unpin <= n.top) && (null != r && n.top + this.$element.height() >= i - r ? "bottom" : null != s && a <= s && "top"),
                this.affixed !== e && (this.affixed = e,
                this.unpin = "bottom" == e ? n.top - a : null,
                this.$element.removeClass("affix affix-top affix-bottom").addClass("affix" + (e ? "-" + e : "")))
            }
        }
        ;
        var i = t.fn.affix;
...
define("index/index-ticket", ["jquery", "core/lib/bootstrap2", "core/common/data.jcokies", "core/common/messages_index_zh_CN"], function(t, e, i, a) {
    function n() {
        function e(t, e) {
            var i = [toshijianchu(e[0]), toshijianchu(e[1])]
              , a = [toshijianchu(e[2]), toshijianchu(e[3])]
        ...
        !function() {
            window.studentDates = window.studentDates || ["2018-06-01", "2018-09-30", "2018-12-01", "2018-12-31", "2018-01-01", "2018-03-31"],
            e(formatDate(new Date), window.studentDates) || (t("#isStudentDan").addClass("disabled"),
            t("#isStudent").addClass("disabled"),
            t("#isStudentLian").addClass("disabled"))
        }(),
        jQuery.support.cors = !0,
        t(function() {
            function e(t) {
            ...
            function i(e) {
                for (var i = "", a = 0; a < e.length; a++)
                    i += "<li data-from=" + e[a].from_station + " data-to=" + e[a].to_station + " data-from-encode=" + e[a].from_station_name_encode + " data-to-encode=" + e[a].to_station_name_encode + ">" + e[a].from_station_name + "-" + e[a].to_station_name + "</li>";
                ...
                t.ajax({
                    ...
                    success: function(e) {
                        ...
                        for (var l = 0; l < i.length; l++)
                            r += "<li data-option=" + i[l][1] + ">" + i[l][0] + "</li>";
                        t(".model-select-option").html(r),
                        o.find("li:first-child").parent().siblings("div.model-select-text").text(o.find("li:first-child").text()).attr("data-value", o.find("li:first-child").attr("data-option")),
                        o.find("li:first-child").parent().siblings(t("input.selected-input")).attr("data-value", o.find("li:first-child").attr("data-option")),
                        t("#station_loading").hide()
                    },
                    error: function(t) {}
                })
            }
            var n = t("div.model-select-box")
              , o = t("#check_model_select")
              , r = t(".input-box .typeahead")
              , s = t("div.model-select-text", n)
              , l = 1
              , c = {};
            t("ul.model-select-option").on("mousedown", "li", function() {
                for (var e = deepClone(c), i = 0; i < e.data.length; i++)
                    t(this).text() == e.data[i][0] && (e.data[i][2] = "click");
                return setStorage("ticketCheckStationList", e),
                t(this).parent().siblings("div.model-select-text").text(t(this).text()).attr("data-value", t(this).attr("data-option")),
                t(this).parent().siblings(t("input.selected-input")).attr("data-value", t(this).attr("data-option")),
                t(this).addClass("seleced data-selected").siblings("li").removeClass("seleced data-selected"),
            ...
            s.click(function(i) {
                if (t("#topicId").val()) {
                    ...
                    o.find("li:first-child").addClass("seleced").siblings("li").removeClass("seleced"),
                    !1
                }
            }),
            o.find("li").each(function(e, i) {
                t(this).hasClass("seleced") && (t(this).addClass("data-selected"),
                t(this).parent().siblings(t("input.selected-input")).attr("data-value", t(this).attr("data-option")))
            }).mousedown(function() {
                return t(this).parent().siblings("div.model-select-text").text(t(this).text()).attr("data-value", t(this).attr("data-option")),
                t(this).parent().siblings(t("input.selected-input")).attr("data-value", t(this).attr("data-option")),
                t(this).addClass("seleced data-selected").siblings("li").removeClass("seleced data-selected"),
                o.slideUp(10, function() {}),
                !1
            ...
            t("#train_num").keydown(function(e) {
                ...
                if ("block" == r.css("display"))
                    ...
                    case 40:
                        ...
                        l++,
                        l > i && (l = 1);
                        var a = Math.floor(r.find("li:nth-child(" + l + ")").offset().top)
                          , n = r.outerHeight()
                          , o = Math.floor(r.find("li:first-child").outerHeight());
                        a > n && r.scrollTop(o * (l - 4)),
                        a < 0 && r.scrollTop(o * (l - 1));
                        break;
                    case 38:
                        var i = t(".input-box .typeahead").children().length;
                        l--,
                        l <= 0 && (l = i);
                        var s = Math.floor(r.find("li:nth-child(" + l + ")").offset().bottom)
                          , n = r.outerHeight()
                          , o = Math.floor(r.find("li:first-child").outerHeight());
            ...
            var d = function(t) {
                ...
                for (e = 0; e < n; e++) {
                    for (i = e + 1; i < n; i++)
                        t[e].from_station === t[i].from_station && t[e].to_station === t[i].to_station && (i = ++e);
                    a.push(t[e])
                }
                return a
            };
            ...
            t(".input-box").on("click", "li", function() {
                t("#dinner_sub_mun").val() && (t("#dinner_sub_mun").removeClass("input-error"),
                t("[data-id=dinner_sub_mun]").hide()),
                t("#numberValue").val() && (t("#numberValue").removeClass("input-error"),
                t("[data-id=numberValue]").hide()),
                t("#train_num").val() && (t("#train_num").removeClass("input-error"),
                t("[data-id=train_num]").hide())
            }),
            ...
            t("#train_num").typeahead({
                ...
                source: function(e, i) {
                    l = 1,
                    r.find("li:first-child").addClass("active").siblings("li").removeClass("active"),
                    t("#train_num").val() && (t("#train_num").removeClass("input-error"),
                    t("[data-id=train_num]").hide());
                    var n = t("#check_in").val().replace(/-/g, "")
                      , o = /^[GTKDCZY]{0,1}[0-9]{0,6}$/;
                    e.toUpperCase().match(o) && (jQuery.support.cors = !0,
                    t.ajax({
                        url: getTrainList,
                        timeout: 1e4,
                        type: "GET",
                        ...
                        success: function(e) {
                            e.data && e.data[0].station_train_code == t("#train_num").val().toUpperCase() && (t("#topicId").val(e.data[0].train_no),
                            a());
                ...
                updater: function(e) {
                    var i = JSON.parse(e);
                    return t("#topicId").attr("value", i.id),
                    t("#station_loading").show(),
                    l = 1,
                    r.find("li:first-child").addClass("active").siblings("li").removeClass("active"),
                    a(),
                    i.nameCode
            ...
            t("#ticket_check_trainNum").val(index_messages.jianma_hanzi),
            h.length > 0 ? (t("#search-history").show(),
            t("#fromStation").val(h[0].from_station),
            t("#fromStationText").val(h[0].from_station_name),
            t("#toStationText").val(h[0].to_station_name),
            t("#toStation").val(h[0].to_station),
            t("#fromStationFan").val(h[0].from_station),
            t("#fromStationFanText").val(h[0].from_station_name),
            t("#toStationFanText").val(h[0].to_station_name),
            t("#toStationFan").val(h[0].to_station),
            t("#fromStationSerial").val(h[0].from_station),
            t("#fromStationSerialText").val(h[0].from_station_name),
            t("#toStationSerialText").val(h[0].to_station_name),
            t("#toStationSerial").val(h[0].to_station),
            t("#fromStationDinner").val(h[0].from_station),
            t("#fromStationDinnerText").val(h[0].from_station_name),
            t("#toStationDinnerText").val(h[0].to_station_name),
            t("#toStationDinner").val(h[0].to_station)) : (t("#search-history").hide(),
            t("#fromStation").val(""),
            t("#fromStationText").val(index_messages.jianma_hanzi),
            t("#toStationText").val(index_messages.jianma_hanzi),
            t("#toStation").val(""),
            t("#fromStationFan").val(""),
            t("#fromStationFanText").val(index_messages.jianma_hanzi),
            t("#toStationFanText").val(index_messages.jianma_hanzi),
            t("#toStationFan").val(""),
            t("#fromStationSerial").val(""),
            t("#fromStationSerialText").val(index_messages.jianma_hanzi),
            t("#toStationSerialText").val(index_messages.jianma_hanzi),
            t("#toStationSerial").val(""),
            t("#fromStationDinner").val(""),
            t("#fromStationDinnerText").val(index_messages.jianma_hanzi),
            t("#toStationDinnerText").val(index_messages.jianma_hanzi),
            t("#toStationDinner").val(""),
            t("#start_sellText").val(index_messages.jianma_hanzi),
            t("#start_sell").val(""),
            t("#destinationText").val(index_messages.jianma_hanzi),
            t("#destination").val("")),
            t("#train_date").val(formatDate(new Date)),
            t("#go_date").val(formatDate(new Date)),
            t("#from_date").val(formatDate(new Date)),
            t("#serial_date").val(formatDate(new Date)),
            t("#dinner_date").val(formatDate(new Date)),
            t("#ticket_check_date").val(formatDate(new Date)),
            t("#check_in").val(formatDate(new Date)),
            t("#iconRightHos").on("click", function() {
                t("#history_ul").width() > t(".history-list-wrap").width() + 85 * p && (t("#history_ul").width() - 85 > t(".history-list-wrap").width() + 85 * p ? (f += 85,
                p++) : (f = t("#history_ul").width() - t(".history-list-wrap").width(),
                p++)),
                t("#history_ul").animate({
                    left: "-" + f + "px"
                })
            }),
            ...
            t(".search-history-btn").on("click", function() {
                ...
                h = [],
                t("#search-history").hide()
            }),
            t("#danChange").on("click", function() {
                var e = t("#fromStation").val();
                t("#fromStation").val(t("#toStation").val()),
                t("#toStation").val(e);
                var i = t("#fromStationText").val();
                t("#fromStationText").val(t("#toStationText").val()),
                t("#toStationText").val(i)
            }),
            t("#returnChange").on("click", function() {
                var e = t("#fromStationFan").val();
                t("#fromStationFan").val(t("#toStationFan").val()),
                t("#toStation").val(e);
                var i = t("#fromStationFanText").val();
                t("#fromStationFanText").val(t("#toStationFanText").val()),
                t("#toStationFanText").val(i)
            }),
            t("#serialChange").on("click", function() {
                var e = t("#fromStationSerial").val();
                t("#fromStationSerial").val(t("#toStationSerial").val()),
                t("#toStationSerial").val(e);
                var i = t("#fromStationSerialText").val();
                t("#fromStationSerialText").val(t("#toStationSerialText").val()),
                t("#toStationSerialText").val(i)
            }),
            t("#search_one").on("click", function() {
                if (t("#fromStation").val() && t("#toStation").val() && t("#train_date").val()) {
                    var e = {};
                    e.from_station_name = t("#fromStationText").val(),
                    e.from_station = t("#fromStation").val(),
                    e.to_station = t("#toStation").val(),
                    e.to_station_name = t("#toStationText").val(),
                    e.train_date = t("#train_date").val(),
                    e.isStudent = t("#isStudentDan").hasClass("active") ? "Y" : "N",
                    e.isHigh = t("#isHighDan").hasClass("active") ? "Y" : "N",
                    e.from_station_name_encode = encodeURI(e.from_station_name),
                    e.to_station_name_encode = encodeURI(e.to_station_name),
                    t("#search-history").show(),
                    setStorage("leftTicketDTO", e),
                    h.unshift(e),
                    h = d(h),
                    setLocalStorage("historyList", h);
                    i(h.slice(0, 10)),
                    window.open(singleWayToOld + "?linktypeid=dc&fs=" + e.from_station_name_encode + "," + e.from_station + "&ts=" + e.to_station_name_encode + "," + e.to_station + "&date=" + e.train_date + "&flag=" + e.isStudent + "," + e.isHigh + ",Y")
                } else
                    t("#fromStation").val() || (t("#fromStationText").addClass("input-error"),
                    noChoseCity(t("#fromStationText"))),
                    t("#toStation").val() || (t("#toStationText").addClass("input-error"),
                    noChoseCity(t("#toStationText"), "46px", "347px", "请选择到达地"))
            }),
            t("#search_two").on("click", function() {
                if (t("#fromStationFan").val() && t("#toStationFan").val() && t("#go_date").val()) {
                    var e = {};
                    e.from_station_name = t("#fromStationFanText").val(),
                    e.from_station = t("#fromStationFan").val(),
                    e.to_station = t("#toStationFan").val(),
                    e.to_station_name = t("#toStationFanText").val(),
                    e.train_date = t("#go_date").val(),
                    e.back_train_date = t("#from_date").val(),
                    e.isStudent = t("#isStudent").hasClass("active") ? "Y" : "N",
                    e.isHigh = t("#isHigh").hasClass("active") ? "Y" : "N",
                    e.from_station_name_encode = encodeURI(e.from_station_name),
                    e.to_station_name_encode = encodeURI(e.to_station_name),
                    t("#search-history").show(),
                    setStorage("leftTicketDTO", e),
                    ...
                    setLocalStorage("historyList", h);
                    i(h.slice(0, 10)),
                    window.open(singleWayToOld + "?linktypeid=wf&fs=" + e.from_station_name_encode + "," + e.from_station + "&ts=" + e.to_station_name_encode + "," + e.to_station + "&date=" + e.train_date + "," + e.back_train_date + "&flag=" + e.isStudent + "," + e.isHigh + ",Y")
                } else
                    t("#fromStationFan").val() || (t("#fromStationFanText").addClass("input-error"),
                    noChoseCity(t("#fromStationFanText"))),
                    t("#toStationFan").val() || (t("#toStationFanText").addClass("input-error"),
                    noChoseCity(t("#toStationFanText"), "46px", "347px", "请选择到达地"))
            }),
            t("#search_three").on("click", function() {
                if (t("#fromStationSerial").val() && t("#toStationSerial").val() && t("#serial_date").val()) {
                    var e = {};
                    e.from_station_name = t("#fromStationSerialText").val(),
                    e.from_station = t("#fromStationSerial").val(),
                    e.to_station = t("#toStationSerial").val(),
                    e.to_station_name = t("#toStationSerialText").val(),
                    e.train_date = t("#serial_date").val(),
                    e.isStudent = t("#isStudentLian").hasClass("active") ? "Y" : "N",
                    e.isHigh = t("#isHighLian").hasClass("active") ? "Y" : "N",
                    e.from_station_name_encode = encodeURI(e.from_station_name),
                    e.to_station_name_encode = encodeURI(e.to_station_name),
                    t("#search-history").show(),
                    t.jc_setPageFrom("12306_index"),
                    setStorage("leftTicketDTO", e),
                    h.unshift(e),
                    h = d(h),
                    setLocalStorage("historyList", h);
                    i(h.slice(0, 10)),
                    window.open(continuityWayToOld + "?linktypeid=lx&fs=" + e.from_station_name_encode + "," + e.from_station + "&ts=" + e.to_station_name_encode + "," + e.to_station + "&date=" + e.train_date + "&flag=" + e.isStudent + ",N,Y")
                } else
                    t("#fromStationSerial").val() || (t("#fromStationSerialText").addClass("input-error"),
                    noChoseCity(t("#fromStationSerialText"))),
                    t("#toStationSerial").val() || (t("#toStationSerialText").addClass("input-error"),
                    noChoseCity(t("#toStationSerialText"), "46px", "347px", "请选择到达地"))
            }),
            t("#check_button").on("click", function() {
                if (t("#check_in").val() && t("#train_num").val()) {
                    var e = {};
                    e.train_date = t("#check_in").val(),
                    e.train_number = t("#train_num").val(),
                    e.ticket_entrance_station = t(".model-select-text").attr("data-value"),
                    e.train_no = t("#topicId").val(),
                    setStorage("ticketCheck", e),
                    window.open(checkInUrl + "?isremoveStore=1"),
                    removeStore("ticketCheck")
                } else
                    t("#train_num").val() || (t("#train_num").addClass("input-error"),
                    noChoseCity(t("#train_num"), "138px", "472px", "请输入车次"));
                return !1
            }),
            t("#sell_button").on("click", function() {
                if (t("#start_sellText").val() && "简拼/全拼/汉字" !== t("#start_sellText").val()) {
                    var e = {};
                    e.station_name = t("#start_sellText").val(),
                    e.station = t("#start_sell").val(),
                    setStorage("sale_time", e),
                    getScSnameListFn(),
                    window.open(sellInUrl + "?station_name=" + e.station_name + "&station_code=" + e.station),
                    removeStore("sale_time")
                } else
                    t("#start_sell").val() || (t("#start_sellText").addClass("input-error"),
                    noChoseCity(t("#start_sellText"), "92px", "472px", "请选择起售车站"))
            }),
            t("#weather_button").on("click", function(e) {
                e.stopPropagation(),
                t("#destination").val() ? t.getJSON(weatherData, function(e) {
                    var i = "";
                    t.each(e, function(e, a) {
                        return t("#destinationText").val() === a.station && (i = a.code),
                        i
                    }),
                    window.open(weatherTitle + i + ".shtml")
                }) : t("#destination").val() && "简拼/全拼/汉字" !== t("#destination").val() || (t("#destinationText").addClass("input-error"),
                noChoseCity(t("#destinationText"), "92px", "472px", "请选择目的地"))
            })
        })
    }
    return {
...
function(t) {
    ...
    function i(e, i, a, n) {
        t(e).focus(function() {
            a = GetDateStr(t(n).hasClass("active") ? stu_control - 1 : other_control - 1),
            t(e).jcalendar({
                isSingle: !1,
                startDate: i,
                endDate: a,
                onpicked: function() {
                    "#go_date" == e && t("#from_date").val(t("#go_date").val()),
                    t(e).blur(),
                    t(e).hasClass("inp-txt_select") || t(e).addClass("inp-txt_select"),
                    t(e).hasClass("error") && t(e).removeClass("error"),
                    "train_date" == t(e).attr("id") && (o(t(e).val(), window.studentDates) ? t("#isStudentDan").removeClass("disabled") : (t("#isStudentDan").addClass("disabled"),
                    t("#isStudentDan").removeClass("active"))),
                    "go_date" == t(e).attr("id") && (o(t(e).val(), window.studentDates) ? t("#isStudent").removeClass("disabled") : (t("#isStudent").addClass("disabled"),
                    t("#isStudent").removeClass("active"))),
                    "serial_date" == t(e).attr("id") && (o(t(e).val(), window.studentDates) ? t("#isStudentLian").removeClass("disabled") : (t("#isStudentLian").addClass("disabled"),
                    t("#isStudentLian").removeClass("active")))
                }
            })
        })
    }
    ...
    i("#dinner_date", formatDate(new Date), GetDateStr(29)),
    i("#train_date", formatDate(new Date), GetDateStr(29), "#isStudentDan"),
    i("#go_date", formatDate(new Date), GetDateStr(29), "#isStudent"),
    function(e, i, a, n) {
        t(e).focus(function() {
            a = GetDateStr(t(n).hasClass("active") ? stu_control - 1 : other_control - 1),
            s = !1,
    ...
    }("#from_date", formatDate(new Date), GetDateStr(29), "#isStudent"),
    i("#serial_date", formatDate(new Date), GetDateStr(29), "#isStudentLian"),
    i("#check_in", formatDate(new Date), GetDateStr(29)),
    i("#ticket_check_date", formatDate(new Date), GetDateStr(29)),
    i("#contract_date", formatDate(new Date), GetDateStr(29)),
    t(".radio-list-ding").on("click", "li", function() {
        t("#dingqiaoID").hasClass("active") ? (a("#refund_start", !0),
        n("#refund_end", !0)) : (a("#refund_start", !1),
        n("#refund_end", !1))
    }),
    a("#refund_start", !0),
    n("#refund_end", !0),
    i("#noTripFromDate", formatDate(new Date), GetDateStr(29)),
    i("#noTripToDate", formatDate(new Date), GetDateStr(29)),
    i("#historyFromDate", formatDate(new Date), GetDateStr(29)),
    i("#historyToDate", formatDate(new Date), GetDateStr(29)),
    i("#travelFromDate", formatDate(new Date), GetDateStr(29)),
    i("#travelToDate", formatDate(new Date), GetDateStr(29))
}),
function(t) {
    ...
    t.jcalendar = function(i, l) {
        ...
        function d(t, e, i, a) {
            var n = new w(new Date(t,e,1))
              , o = new w(new Date(i,a,1));
            K.init(n, 0),
            X.draw(1),
            K.init(o, 1),
            X.draw(0),
        ...
        function u(t) {
            return t = T ? t.replace(T, "") : t,
            t = k ? t.replace(k, "") : t
        }
        function h() {
            z[0] && t(z[1]).attr("class") == z[2] && p(a, z[3], !1),
            f() ? a[0].children[2].children[0].style.color = I : a[0].children[2].children[0].style.color = "#297405",
            v(a, t(x).val())
        }
        function f() {
            var t = new Date($)
        ...
        function p(t, e, i) {
            ...
            var a = t[0].children[0].children[0].children[3].children[0].value
              ...
              , o = t[0].children[0].children[2].children
              , r = t[0].children[1].children[2].children;
            for (var s in o)
                if (o[s].children) {
                    var l = o[s].children[0].numHTML
                      ...
                      , h = i ? c < d : c > d;
                    h && (o[s].children[0].style.color = I,
                    "2" == q && (o[s].children[1].style.color = I),
                    o[s].onclick = null,
                    o[s].style.cursor = "auto")
                }
            for (var s in r)
                if (r[s].children) {
                    var l = r[s].children[0].numHTML
                      , c = new Date(a,n,l)
                      , d = new Date(e.substring(0, 4),e.substring(5, 7) - 1,e.substring(8, 10))
                      , h = i ? c < d : c > d;
                    h && (r[s].children[0].style.color = I,
                    "2" == q && (o[s].children[1].style.color = I),
                    r[s].onclick = null,
                    r[s].style.cursor = "auto")
                }
        }
        function v(t, e) {
            if ((e = u(e)) && e.length >= 10) {
                ...
                var i = t[0].children[0].children[0].children[3].children[0].value
                  ...
                  , n = t[0].children[0].children[2].children
                  , o = t[0].children[1].children[2].children;
                for (var r in n)
                    if (n[r].children) {
                        var s = n[r].children[0].numHTML
                          , l = new Date(i,a - 1,s)
                          , c = new Date(e.substring(0, 4),e.substring(5, 7) - 1,e.substring(8, 10));
                        l.getTime() == c.getTime() ? (n[r].style.border = "1px solid #a5b9da",
                        n[r].style.background = L) : (n[r].style.border = "",
                        n[r].style.background = "")
                    }
                for (var r in o)
                    if (o[r].children) {
                        var s = o[r].children[0].numHTML
                          , l = new Date(i,a,s)
                          , c = new Date(e.substring(0, 4),e.substring(5, 7) - 1,e.substring(8, 10));
                        l.getTime() == c.getTime() ? (o[r].style.border = "1px solid #a5b9da",
                        o[r].style.background = L) : (o[r].style.border = "",
        ...
        function g(t) {
            ...
            for (var i in e)
                if (e[i].innerHTML) {
                    var a = 0 == t ? r[1].value : r[2].value
                      , n = m(e[i].innerHTML)
                      , o = $.substring(0, 4)
                      , l = Number($.substring(5, 7))
                      , c = j.substring(0, 4)
                      , d = Number(j.substring(5, 7));
                    a < o || a > c || a == o && n < l || a == c && n > d ? (e[i].style.color = I,
                    e[i].style.cursor = "auto") : (e[i].style.color = N,
                    e[i].style.cursor = "pointer")
                }
        }
        function _(t, e) {
            s[t].innerHTML = "";
            for (var i = "", a = e - 5; a <= e + 4; a++)
                a < $.substring(0, 4) || a > j.substring(0, 4) ? i += '<li style="color: ' + I + ';cursor:auto;">' + a + "</li>" : i += '<li style="color: ' + N + ';cursor:pointer;">' + a + "</li>";
            s[t].innerHTML = i;
            var o = 1 == t ? n[5] : n[11];
            if (Number(s[t].children[0].innerHTML) - 1 < $.substring(0, 4) ? (o.children[0].style.color = I,
            o.children[0].style.cursor = "auto") : (o.children[0].style.color = N,
            o.children[0].style.cursor = "pointer"),
            Number(s[t].children[9].innerHTML) + 1 > j.substring(0, 4) ? (o.children[1].style.color = I,
            o.children[1].style.cursor = "auto") : (o.children[1].style.color = N,
            o.children[1].style.cursor = "pointer"),
            3 == t)
                var l = s[3].parentElement.getElementsByTagName("li");
            else if (1 == t)
                var l = n[4].getElementsByTagName("li");
            for (var c = 0; c < l.length; c++)
                l[c].innerHTML < $.substring(0, 4) || l[c].innerHTML > j.substring(0, 4) ? l[c].onclick = function() {
                    n[4].style.display = "none",
                    n[10].style.display = "none"
                }
                : l[c].onclick = function() {
                    var e = this.innerHTML
                      , i = 3 == t ? m(r[3].value) + "" : m(r[0].value) + "";
                    i = 1 == i.length ? "0" + i : i,
                    3 == t ? (d(e, i - 2, e, i - 1),
                    s[3].parentElement.style.display = "none") : 1 == t && (d(e, i - 1, e, i),
                    n[4].style.display = "none"),
                    h()
                }
        }
        function w(t) {
            ...
            function r(t) {
                ...
                this.isLeap = !1,
                e = 1; e < 13 && c > 0; e++)
                    r > 0 && e == r + 1 && 0 == this.isLeap ? (--e,
                    this.isLeap = !0,
                    s = a(this.year)) : s = o(this.year, e),
                    1 == this.isLeap && e == r + 1 && (this.isLeap = !1),
                    c -= s,
                    0 == this.isLeap && this.monCyl++;
                0 == c && r > 0 && e == r + 1 && (this.isLeap ? this.isLeap = !1 : (this.isLeap = !0,
                --e,
                --this.monCyl)),
                c < 0 && (c += s,
                --e,
            ...
            this.isToday = !1,
            this.isRestDay = !1,
            this.solarYear = l(t, "yyyy"),
            this.solarMonth = l(t, "MM"),
            this.solarDate = l(t, "dd"),
            this.calendarDate = new Date(this.solarYear,this.solarMonth - 1,this.solarDate),
            this.solarWeekDay = t.getDay(),
            ...
            this.lunarMonthInChinese = this.lunarIsLeapMonth ? "闰" + G[c.month - 1] : G[c.month - 1],
            this.lunarDate = c.day,
            this.showInLunar = this.lunarDateInChinese = function(t, e) {
                var i;
                switch (e) {
                case 10:
                    i = "初十";
            ...
            this.jieqi = "",
            this.restDays = 0,
            e(this.solarYear, 2 * (this.solarMonth - 1)) == l(t, "d") && (this.showInLunar = this.jieqi = W[2 * (this.solarMonth - 1)]),
            e(this.solarYear, 2 * (this.solarMonth - 1) + 1) == l(t, "d") && (this.showInLunar = this.jieqi = W[2 * (this.solarMonth - 1) + 1]),
            "清明" == this.showInLunar && (this.showInLunar = "清明",
            this.restDays = 1),
            this.solarFestival = R[l(t, "MM") + l(t, "dd")],
            ...
            this.lunarFestival = Z[this.lunarIsLeapMonth ? "00" : s(this.lunarMonth) + s(this.lunarDate)],
            ...
            12 == this.lunarMonth && this.lunarDate == o(this.lunarYear, 12) && (this.lunarFestival = Z["0100"],
            this.restDays = 1),
        ...
        y.$el = t(i),
        y.el = i,
        y.options = t.extend({}, t.jcalendar.defaultOptions, l);
        var x = y.el.selector
          , b = {
            closeView: y.options.closeCalendar
        }
          , C = y.options.onpicked;
        t(x)[0].onchange = C;
        var S = y.options.isSingle
          , D = y.options.showFormat
          , T = y.options.formatBeforeInfo
          , k = y.options.formatAfterInfo
          , $ = y.options.startDate;
        $ = $ || "1901-01-01";
        var j = y.options.endDate;
        j = j || "2050-12-31",
        $ = $.substring(0, 4) + "/" + $.substring(5, 7) + "/" + $.substring(8, 10),
        j = j.substring(0, 4) + "/" + j.substring(5, 7) + "/" + j.substring(8, 10);
        var M = y.options.isTodayBlock
          , L = y.options.todayClickColor
          , I = y.options.noClickColor
          , F = y.options.restColor
          , O = y.options.noRestColor
          , N = y.options.clickByYearMonth
          , H = y.options.lunarColor
          , q = y.options.isTwoRows
          , E = y.options.isYearMonthDisabled
          , z = y.options.condition
          , P = {
            "2018-09-29": "班",
            "2018-09-30": "班"
        }
        ...
        o[0].onclick = function() {
            ...
            if (new Date(a.getFullYear(),Number(a.getMonth()),a.getDate()) >= new Date($))
                d(t - 1, e - 1, t - 1, e);
            else {
                var i = new Date($);
        ...
        o[1].onclick = function() {
            var t = r[1].value
              ...
              , i = new Date(t,e - 1,1)
              , a = new Date(i.getTime() - 864e5);
            new Date(a.getFullYear(),Number(a.getMonth()),a.getDate()) >= new Date($) && d(t, e - 2, t, e - 1),
            h()
        }
        ,
        o[6].onclick = function() {
            var t = r[1].value
              , e = m(r[0].value);
            t == j.substring(0, 4) && e == j.substring(5, 7) || d(t, e, t, Number(e) + 1),
            h()
        }
        ,
        o[5].onclick = function() {
            var t = r[1].value
              , e = m(r[0].value);
            if (t < j.substring(0, 4))
                d(Number(t) + 1, e - 1, Number(t) + 1, e);
            else {
                var i = new Date(j);
                d(i.getFullYear(), i.getMonth(), i.getFullYear(), i.getMonth() + 1)
            }
        ...
        o[8].onclick = function() {
            var t = r[2].value
              , e = m(r[3].value);
            new Date(t,e - 1,1) <= new Date(j) && d(t, e - 1, t, e),
            h()
        }
        ,
        ...
        var Y = new Array("","一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月","一月")
          ...
          , Q = (-1 != navigator.userAgent.indexOf("MSIE") && window.opera,
        [19416, 19168, 42352, 21717, 53856, 55632, 91476, 22176, 39632, 21970, 19168, 42422, 42192, 53840, 119381, 46400, 54944, 44450, 38320, 84343, 18800, 42160, 46261, 27216, 27968, 109396, 11104, 38256, 21234, 18800, 25958, 54432, 59984, 28309, 23248, 11104, 100067, 37600, 116951, 51536, 54432, 120998, 46416, 22176, 107956, 9680, 37584, 53938, 43344, 46423, 27808, 46416, 86869, 19872, 42448, 83315, 21200, 43432, 59728, 27296, 44710, 43856, 19296, 43748, 42352, 21088, 62051, 55632, 23383, 22176, 38608, 19925, 19152, 42192, 54484, 53840, 54616, 46400, 46496, 103846, 38320, 18864, 43380, 42160, 45690, 27216, 27968, 44870, 43872, 38256, 19189, 18800, 25776, 29859, 59984, 27480, 21952, 43872, 38613, 37600, 51552, 55636, 54432, 55888, 30034, 22176, 43959, 9680, 37584, 51893, 43344, 46240, 47780, 44368, 21977, 19360, 42416, 86390, 21168, 43312, 31060, 27296, 44368, 23378, 19296, 42726, 42208, 53856, 60005, 54576, 23200, 30371, 38608, 19415, 19152, 42192, 118966, 53840, 54560, 56645, 46496, 22224, 21938, 18864, 42359, 42160, 43600, 111189, 27936, 44448])
          ...
          , K = function() {
            ...
            function a(t, a) {
                ...
                var r = new w(new Date(t.solarYear,o,1))
                  , s = r.solarWeekDay
                  , l = new w(new Date(t.solarYear,t.solarMonth,1))
                  , c = l.solarWeekDay
                  , d = 0
                  , u = new w(new Date(t.solarYear,t.solarMonth - 1,1))
                  , h = u.solarWeekDay;
                if (S)
                    n.lines = Math.ceil((h + e(t.solarYear, t.solarMonth - 1)) / 7);
                else if (0 == a) {
                    ...
                    n.lines = 6;
                for (var v = 0; v < n.dateArray.length; v++)
                    if (0 != u.restDays && (d = u.restDays),
                    d > 0 && (u.isRest = !0),
                    h-- > 0 || u.solarMonth != t.solarMonth)
                        n.dateArray[v] = null;
                    else {
                        var a = new w(new Date);
                        u.solarYear == a.solarYear && u.solarMonth == a.solarMonth && u.solarDate == a.solarDate && (u.isToday = !0),
                        n.dateArray[v] = u,
                        u = new w(i(u.date, 1)),
                        d--
                    }
          ...
          , X = function() {
            function e(e) {
                ...
                for (var l = 0; l < r.length; l++)
                    if (null != r[l]) {
                        ...
                        u = k ? u + k : u;
                        var h = c("DIV");
                        r[l].isToday && (h.style.border = "1px solid #a5b9da",
                        h.style.background = L),
                        h.className = "cell",
                        "2" == q && (h.style.height = "36px"),
                        h.style.left = l % 7 == 0 ? "0px" : l % 7 * 42 + 3 + "px",
                        h.style.top = Math.floor(l / 7) * s + 5 + "px",
                        r[l].calendarDate >= new Date($) && r[l].calendarDate <= new Date(j) && (h.onclick = function(e) {
                            return function() {
                                t(x).val(e),
                                a.hide(),
                                t(x).change()
                        ...
                        var f = c("DIV");
                        f.className = "so",
                        f.style.color = l % 7 == 0 || l % 7 == 6 || r[l].isRest || r[l].isToday ? F : O,
                        r[l].calendarDate >= new Date($) && r[l].calendarDate <= new Date(j) || (f.style.color = I),
                        "3" == q ? (r[l].solarFestival ? f.innerHTML = r[l].solarFestival : r[l].lunarFestival ? f.innerHTML = r[l].lunarFestival : r[l].isToday ? f.innerHTML = "今天" : f.innerHTML = "0" == r[l].solarDate.substring(0, 1) ? r[l].solarDate.substring(1) : r[l].solarDate,
                        f.numHTML = "0" == r[l].solarDate.substring(0, 1) ? r[l].solarDate.substring(1) : r[l].solarDate) : (f.innerHTML = "0" == r[l].solarDate.substring(0, 1) ? r[l].solarDate.substring(1) : r[l].solarDate,
                        f.numHTML = "0" == r[l].solarDate.substring(0, 1) ? r[l].solarDate.substring(1) : r[l].solarDate);
                        var p = c("SPAN");
                        if (p.className = "holiday",
                        P[d] ? (p.innerHTML = P[d],
                        h.appendChild(p)) : U[d] && (p.innerHTML = U[d],
                        h.appendChild(p)),
                        h.appendChild(f),
                        "2" == q) {
                            var v = c("DIV");
                            r[l].calendarDate >= new Date($) && r[l].calendarDate <= new Date(j) ? v.style.color = H : v.style.color = I,
                            v.innerHTML = r[l].showInLunar,
                            h.appendChild(v)
                        }
                        i.appendChild(h)
                    }
            ...
            return {
                ...
                resetYM: function(t, e) {
                    r[0].value = Y[Number(t.solarMonth)],
                    r[1].value = t.solarYear,
                    r[2].value = e.solarYear,
                    r[3].value = Y[Number(e.solarMonth)]
                }
            }
        }()
          , tt = new w(new Date);
        ...
        E) {
            ...
            o[9].onclick = function() {
                if (s[3].getElementsByTagName("li")[0].innerHTML < 1902 || "auto" == this.style.cursor)
                    return void (n[10].style.display = "none");
            ...
            ;
            for (var at = s[0].getElementsByTagName("li"), nt = 0; nt < at.length; nt++)
                at[nt].onclick = function() {
                ...
                ;
            g(0),
            r[1].onfocus = function() {
                _(1, Number(r[1].value)),
            ...
            ;
            for (var ot = s[4].getElementsByTagName("li"), nt = 0; nt < ot.length; nt++)
                ot[nt].onclick = function() {
                    if ("auto" == this.style.cursor)
                        return s[0].style.display = "none",
                        void (s[4].style.display = "none");
                    var t = r[2].value
                ...
                ;
            g(4),
            r[2].onfocus = function() {
                _(3, Number(r[2].value)),
                n[10].style.display = "block"
            }
            ,
            r[2].onblur = function() {
                n[10].style.display = "none"
            ...
            for (var nt = 0; nt < 4; nt++)
                r[nt].disabled = !1,
                r[nt].style.cursor = "pointer"
        }
        var rt = new Date;
        r[0].value = Y[rt.getMonth() + 1],
        r[1].value = rt.getFullYear(),
        r[2].value = 11 == rt.getMonth() ? rt.getFullYear() + 1 : rt.getFullYear(),
        r[3].value = Y[rt.getMonth() + 2],
        function() {
            n[4].style.display = "none",
            e = !0;
            var i = S ? 261 : 522
              , o = document.body.clientWidth - i - 10
              , r = t(x).offset().top
              , s = t(x).offset().left;
            s = s >= o ? o : s;
            ...
            a.css("top", r + l);
            var c = u(t(x).val());
            c && c.length > 4 && c.substring(0, 4) > 1900 && c.substring(0, 4) < 2051 && d(c.substring(0, 4), c.substring(5, 7) - 1, c.substring(0, 4), c.substring(5, 7)),
            h(),
            a.show()
        }()
    }
    ...
    function n() {
        ...
        t("#search_four").on("click", function() {
            if (t("#dinner_date").val() && t("#dinner_sub_mun").val()) {
                var e = t("#dinner_date").val()
                  , i = t("#dinner_sub_mun").val();
                window.open(orderDinner + "?date=" + e + "&code=" + i)
            } else
                t("#dinner_sub_mun").val() && "请输入车次" !== t("#dinner_sub_mun").val() || (t("#dinner_sub_mun").addClass("input-error"),
                noChoseCity(t("#dinner_sub_mun"), "158px", "472px", "请填写车次")),
                t("#dinner_date").val() || (t("#dinner_date").addClass("input-error"),
                noChoseCity(t("#dinner_date"), "112px", "375px", "请输入出发日期"))
        }),
        t("#dinner_sub_mun").keydown(function(i) {
            $option_typeahead = t(".dinner-yuding .typeahead");
            var a = t(".dinner-yuding .typeahead").children().length
              , i = i || window.target;
            if ("block" == $option_typeahead.css("display"))
                switch (i.keyCode) {
                case 40:
                    e++,
                    e > a && (e = 1);
                    ...
                    n > o && $option_typeahead.scrollTop(r * (e - 4)),
                    n < 0 && $option_typeahead.scrollTop(r * (e - 1));
                    break;
                case 38:
                    e--,
                    e <= 0 && (e = a);
        ...
        t("#dinner_sub_mun").typeahead({
            ...
            source: function(i, a) {
                ...
                t("#dinner_sub_mun").val() && (t("#dinner_sub_mun").removeClass("input-error"),
                t("[data-id=dinner_sub_mun]").hide());
                var n = t("#dinner_date").val().replace(/-/g, "")
                  , o = /^[GD][0-9]{0,6}$/;
            ...
            updater: function(i) {
                var a = JSON.parse(i);
                return t("#dinner_sub_code").attr("value", a.id),
                e = 1,
                $option_typeahead.find("li:first-child").addClass("active").siblings("li").removeClass("active"),
                a.nameCode
            }
...
define("index/late_spot", ["jquery"], function($) {
    function lateSpot() {
        var index = 0
          , depotValue = getLocalStorage("depotValue");
        $("#numberValue").keyup(function(e) {
            if (38 != e.keyCode && 40 != e.keyCode && 13 != e.keyCode) {
                ...
                if ($.each(finalDepot, function(t, e) {
                    ...
                    if ($childrens = $("#train_hide").children(),
                    !e.match(i))
                        return t + 1 == finalDepot.length ? void (0 === trainListArr.length ? $("#train_hide").append('<li class="notMatch">暂无匹配项</li>') : e.match(i) ? $("#train_hide").append('<li class="notMatch">暂无匹配项</li>') : $("#train_hide li").each(function() {
            ...
            case 40:
                ...
                index > len && (index = $("#train_hide").children().length),
                ...
                liTop < 0 && $("#train_hide").scrollTop(liHeight * (index - 1)),
                liTop >= trainList && $("#train_hide").scrollTop(liHeight * (index - 4));
                break;
            case 38:
                index--,
                index <= 0 && (index = 1),
        ...
        $("#numberValue").focus(function() {
            $("#stationValueText").val() && "简拼/全拼/汉字" !== $("#stationValueText").val() ? ($("#train_hide ").show(),
            $("#numberValue").removeClass("input-error"),
            $("[data-id=numberValue]").hide()) : ($("#numberValue").addClass("input-error"),
            noChoseCity($("#numberValue"), "184px", "472px", "请选择车次"))
        }),
        $(document).bind("click", function(t) {
            for (var t = t || window.event, e = t.target || t.srcElement; e; ) {
                if (e.id && ("train_hide" == e.id || "numberValue" == e.id))
                    return;
                e = e.parentNode
            }
        ...
        $("#bie_button").on("click", function() {
            if ("" == $("#stationValueText").val || "" == $("#numberValue").val())
                $("#stationValue").val() || ($("#stationValueText").addClass("input-error"),
                noChoseCity($("#stationValueText"), "138px", "472px", "请选择车站")),
                $("#numberValue").val() || ($("#numberValue").addClass("input-error"),
                noChoseCity($("#numberValue"), "184px", "472px", "请选择车次"));
            else {
                var t = $("#stationValueText").val()
                  , e = $("#stationValue").val()
                  , i = $("#numberValue").val()
                  , a = $('li[name="zwd_type"][class="active"]').attr("zwd")
                  , n = encodeURI(t)
                  , o = encodeURI(e)
                  , r = encodeURI(i);
        ...
        $(".radio-list-ding li").on("click", function() {
            if (-1 != $(".radio-list-ding li.active").text().indexOf("乘车日期")) {
                ...
                $("#refund_end").val(formatDate(new Date(t))),
                $("#refund_start").focus(function() {
                    isLiandong = !0,
                    $("#refund_start").jcalendar({
                        ...
                        onpicked: function() {
                            $("#refund_start").blur(),
                            $("#refund_start").hasClass("inp-txt_select") || $("#refund_start").addClass("inp-txt_select"),
                            $("#refund_start").hasClass("error") && $("#refund_start").removeClass("error")
                        }
                    })
                }),
                $("#refund_end").focus(function() {
                    ...
                    $("#refund_end").jcalendar({
                        ...
                        onpicked: function() {
                            $("#refund_end").blur(),
                            $("#refund_end").hasClass("inp-txt_select") || $("#refund_end").addClass("inp-txt_select"),
                            $("#refund_end").hasClass("error") && $("#refund_end").removeClass("error")
                        }
                    })
                })
            } else {
                ...
                $("#refund_start").val(formatDate(new Date(t))),
                $("#refund_start").focus(function() {
                    isLiandong = !0,
                    $("#refund_start").jcalendar({
                        isSingle: !1,
        ...
        $("#refund_button").on("click", function(t) {
            ...
            $("#refund_end").val() && $("#refund_start").val()) {
                ...
                var i = encodeURI($("#refund_start").val())
                  , a = encodeURI($("#refund_end").val())
                  , n = encodeURI($("#refund_code").val())
                  , o = encodeURI(e);
...
require.config({
    ...
    paths: {
        ...
        cityName: "core/common/city_name"
    },
    waitSeconds: 0
}),
